...
INSERT INTO users (
  ...
  ('11000000-0000-0000-0000-000000000010', 920000010, 'admin_hertz', 'Admin HERTZ', 'https://api.dicebear.com/8.x/initials/svg?seed=Admin%20HERTZ&backgroundColor=020617&textColor=22c55e', 'admin', 420, 'Admin', 'HERTZ', NOW() - INTERVAL '150 days', NULL, NULL, 'Admin platform HERTZ. Moderasi konten, publish queue Telegram, dan audit tools.', 'Jakarta, ID', '["product ops", "moderation", "automation"]'::jsonb, '{"x": "hertz_trader", "telegram": "hertz_admin", "linkedin": "hertz-trader"}'::jsonb, '{"experienceLevel": "professional", "markets": ["forex", "crypto", "indices"], "sinceYear": 2010, "style": "Platform oversight"}'::jsonb, NOW() - INTERVAL '3 days', NOW() - INTERVAL '160 days'),
...
VALUES
  ...
  ('71000000-0000-0000-0000-000000000016', 'hzx_demo16', '51000000-0000-0000-0000-000000000046', '11000000-0000-0000-0000-000000000010', 'original', 'admin', 'general', 'published', 'Tools workspace seed: Profitability and Market Pulse.', NULL, NULL, NULL, NOW() - INTERVAL '20 hours', NOW() - INTERVAL '20 hours', NOW() - INTERVAL '20 hours')
...
VALUES
  ...
  ('71000000-0000-0000-0000-000000000009', 'NAS100', 'M30', 0.8000, 'long', '18240 - 18220', 18190, 18380, 'Opening drive', 62, 'Hertz seed'),
...
VALUES
  ...
  ('83000000-0000-0000-0000-000000000006', '82000000-0000-0000-0000-000000000003', '11000000-0000-0000-0000-000000000005', 'Aku lagi susun catatan psikologi buat feed. Perlu review?', NOW() - INTERVAL '1 hour'),
  ...
  ('83000000-0000-0000-0000-000000000011', '82000000-0000-0000-0000-000000000003', '11000000-0000-0000-0000-000000000005', 'Aku buat versi pendeknya dulu untuk feed, versi panjang masuk catatan pribadi.', NOW() - INTERVAL '35 minutes'),
  ...
  ('83000000-0000-0000-0000-000000000020', '82000000-0000-0000-0000-000000000003', '11000000-0000-0000-0000-000000000005', 'Draft catatan selesai malam ini. Saya tag kamu untuk review.', NOW() - INTERVAL '8 minutes'),
...
VALUES
  ('97000000-0000-0000-0000-000000000001', crypt('hz_seed_active_key_2026', gen_salt('bf')), 'hz_actv', 'Hertz Mobile (seed)', '11000000-0000-0000-0000-000000000010', 'https://hertz.cloudnexify.com,http://localhost:3000', true, NOW() - INTERVAL '2 hours', NOW() - INTERVAL '30 days'),
...
VALUES
  ('87000000-0000-0000-0000-000000000001', '11000000-0000-0000-0000-000000000010', 'admin', 'hertz.demo_seed.loaded', 'seed', NULL, '{"version":"001","surfaces":["feed","outlook","dm","profile","tools"]}', '127.0.0.1', NOW() - INTERVAL '2 minutes'),
