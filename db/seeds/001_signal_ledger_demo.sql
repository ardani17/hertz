...
VALUES
  ...
  ('20000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000001', '<p>Admin note: Market Pulse di right rail masih data mock untuk testing UI. Jangan dipakai sebagai sinyal live sampai endpoint market resmi kita sambungkan.</p>', 'Admin note market pulse mock', 'general', 'admin', 'published', 'signal-seed-admin-market-pulse', NULL, NULL, NOW() - INTERVAL '4 hours'),
...
INSERT INTO post_market_context (
  ...
  ('30000000-0000-0000-0000-000000000001', 'XAUUSD', 'M15', 1.00, 'long', 2336.20, '2334-2336', 2328.00, 2352.00, 2342.00, 2348.00, 2352.00, 'Liquidity sweep + rejection', 72, 'Horizon demo'),
  ('30000000-0000-0000-0000-000000000003', 'BTCUSDT', 'H1', 0.75, 'long', 67020.00, '66800-67020', 66180.00, 68400.00, 67500.00, 67980.00, 68400.00, 'Break and retest', 64, 'Binance demo'),
  ('30000000-0000-0000-0000-000000000007', 'EURUSD', 'M5', 0.50, 'short', 1.0734, '1.0730-1.0738', 1.0752, 1.0698, 1.0718, 1.0706, 1.0698, 'Session scalp', 58, 'Horizon demo'),
...
VALUES
  ...
  ('50000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000002', 'Market Pulse di seed ini adalah data demonstrasi. Label Data sementara wajib tetap terlihat sampai endpoint live dibuat.', 4, 0, 'published', NOW() - INTERVAL '3 hours', NOW() - INTERVAL '3 hours');
