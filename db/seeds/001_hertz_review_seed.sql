...
VALUES
  ('40000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', '/images/hertz-seed/chart-xauusd.svg', 'image', 'seed/xauusd-chart.svg', 235000, NOW() - INTERVAL '8 minutes'),
  ('40000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000001', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/xauusd-depth.svg', 228000, NOW() - INTERVAL '8 minutes'),
  ('40000000-0000-0000-0000-000000000003', '20000000-0000-0000-0000-000000000002', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/journal-desk.svg', 196000, NOW() - INTERVAL '23 minutes'),
  ('40000000-0000-0000-0000-000000000004', '20000000-0000-0000-0000-000000000003', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/btc-1.svg', 210000, NOW() - INTERVAL '41 minutes'),
  ('40000000-0000-0000-0000-000000000005', '20000000-0000-0000-0000-000000000003', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/btc-2.svg', 210000, NOW() - INTERVAL '41 minutes'),
  ('40000000-0000-0000-0000-000000000006', '20000000-0000-0000-0000-000000000003', '/images/hertz-seed/chart-xauusd.svg', 'image', 'seed/btc-3.svg', 210000, NOW() - INTERVAL '41 minutes'),
  ('40000000-0000-0000-0000-000000000007', '20000000-0000-0000-0000-000000000003', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/btc-4.svg', 210000, NOW() - INTERVAL '41 minutes'),
  ('40000000-0000-0000-0000-000000000008', '20000000-0000-0000-0000-000000000007', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/eurusd.svg', 182000, NOW() - INTERVAL '2 hours 40 minutes'),
  ('40000000-0000-0000-0000-000000000009', '20000000-0000-0000-0000-000000000010', '/images/hertz-seed/chart-mini.svg', 'image', 'seed/gbpjpy.svg', 191000, NOW() - INTERVAL '5 hours');
