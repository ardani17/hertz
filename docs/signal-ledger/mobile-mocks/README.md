# Signal Ledger Mobile Mock Reference

Tanggal simpan: 2026-05-09

Mock ini adalah acuan visual mobile yang sudah disetujui untuk implementasi Signal Ledger.

## File Acuan

- `mobile-mock-board-3-screens.png` — board lengkap berisi 3 layar mobile.
- `mobile-mock-01-feed.png` — feed timeline mobile.
- `mobile-mock-02-post-detail.png` — detail post mobile.
- `mobile-mock-03-composer.png` — composer/member post mobile.
