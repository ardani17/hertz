...
describe('validateHertzImageUploadType', () => {
  it.each(['image/jpeg', 'image/png', 'image/webp'])('accepts %s for HERTZ web posts', (mime) => {
    expect(validateHertzImageUploadType(mime)).toBe(true);
  });
