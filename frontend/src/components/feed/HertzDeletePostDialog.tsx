...
export function HertzDeletePostDialog({
  ...
  return (
    <div className={styles.backdrop} role="presentation" onClick={(event) => { event.stopPropagation(); onCancel(); }}>
      <div className={styles.dialog} role="dialog" aria-modal="true" aria-labelledby="delete-post-title" aria-describedby="delete-post-body" onClick={(event) => event.stopPropagation()}>
