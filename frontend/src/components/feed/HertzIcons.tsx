...
export function LoveIcon({ className }: IconProps) {
  return (
    <IconBase className={className}>
      <path d="M12 20.2s-7.5-4.55-9.15-9.15C1.73 7.93 3.63 5 6.73 5c1.8 0 3.2.92 4.02 2.2A4.7 4.7 0 0 1 14.77 5c3.1 0 5 2.93 3.88 6.05C17 15.65 12 20.2 12 20.2Z" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
    </IconBase>
  );
}
